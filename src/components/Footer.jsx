      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <h4>Services</h4>
            <ul>
              <li><Link to="/services" onClick={() => window.scrollTo(0, 0)}>Ma Tensa</Link></li>
          ...
          <div className="footer-col">
            ...
            <div className="footer-app-buttons">
              ...
              <a 
                href="https://apps.apple.com/lb/app/matensa/id1617027453" 
                target="_blank" 
                rel="noopener noreferrer"
                className="footer-app-link"
              >
        ...
        <div className="footer-bottom">
          <p>&copy; 2026 Connect Services SARL. All rights reserved.</p>
          <p>
